...
print(f"Q1: le nom de l'etudiant est: {etudiant ['nom']}")
...
etudiant['couriel']= '2112344@cegepmontpetit.ca'
print(f"Q2:voici le couriel de l'etudiant qui a été ajouté: {etudiant['couriel']}")
...
print(f"Q3:voici le nouveau couriel de l'etudiant : {etudiant['couriel']}")
...
print(f"Q5: on a enlevé l'age de l'etudiant, sa valeur etait {age_supprime}")
...
nom_paires = len(etudiant)
print(f"Q6: Nous avons maintenant {nom_paires} paires clés-valeurs.")
